...
//  DreamLister
//
//  Created by LALIT JAGTAP on 7/25/17.
...
//        generateItemTestData()
    ...
    func generateItemTestData() {
        let item = Item(context: context)
        item.title = "Macbook Pro"
        item.price = 1800
        item.details = "I cant wait for Septemeber event, I hope they release new MBPs"
